        ...
        child: Column(
          ...
          children: [
            ...
            AnimatedCrossFade(
              ...
              secondChild: Padding(padding: const EdgeInsets.all(8.0), child: Text('Ash Reads',style: Theme.of(context).textTheme.displayMedium!.regular.copyWith(color: AppColors.white,fontSize: 32.sp))),

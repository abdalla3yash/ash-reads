...
class ErrorHandler {
  ...
  Failure _handleDioError(DioException dioError) {
    switch (dioError.type) {
      ...
      default:
        return dioError.response?.data["message"] != null ?  Failure(dioError.response!.statusCode!,dioError.response!.data["message"]) :ErrorType.unKnown.getFailure();
    }
  }
}
